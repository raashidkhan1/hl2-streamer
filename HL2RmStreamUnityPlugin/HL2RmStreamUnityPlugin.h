...
namespace HL2Stream
{
	...
	FUNCTIONS_EXPORTS_API BYTE* __stdcall GetLongThrowDepthData(int* dataSize);

	FUNCTIONS_EXPORTS_API void __stdcall FreeUnmanagedMemory(BYTE* ptr);
	...
	std::shared_ptr<RMCameraReader> m_cameraReader;
