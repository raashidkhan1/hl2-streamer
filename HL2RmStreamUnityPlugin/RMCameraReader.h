...
public:
	...
	std::vector<BYTE> GetLongThrowDepthData(std::shared_ptr<IResearchModeSensorFrame> spSensorFrame, std::shared_ptr<IResearchModeSensorDepthFrame> spDepthFrame);
	//std::vector<BYTE> GetRGBData(IResearchModeSensorFrame* pSensorFrame, IResearchModeSensorVLCFrame* pVLCFrame);
	...
	std::shared_ptr<IResearchModeSensorFrame> m_spSensorFrame = nullptr;
